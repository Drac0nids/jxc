...
class PurchaseOrdersController extends ChangeNotifier {
  ...
  String? validateQuery({
    ...
    if (!canView) {
      return '当前角色无采购记录查询权限，仅 OWNER/PURCHASER 可查看';
    }
  ...
  Future<bool> load({
    ...
    try {
      _data = await _repository.fetchPurchaseOrders(
