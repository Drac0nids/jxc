...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'stock-check-logs',
        name: 'stock-check-logs',
        meta: { roles: ['OWNER', 'PURCHASER'] },
        component: () => import('@/pages/StockCheckLogsPage.vue'),
      },
      {
        path: 'trend',
        name: 'trend',
      ...
      },
      {
        ...
        name: 'serials',
        meta: { roles: ['OWNER', 'PURCHASER', 'SALES'] },
        component: () => import('@/pages/SerialsPage.vue'),
      },
      {
        path: 'suppliers',
        name: 'suppliers',
      ...
      },
      {
        ...
        meta: { roles: ['OWNER', 'PURCHASER'] },
        component: () => import('@/pages/ExpiringBatchesPage.vue'),
      },
      {
        path: 'inbound-logs',
        name: 'inbound-logs',
        meta: { roles: ['OWNER', 'PURCHASER'] },
        component: () => import('@/pages/InboundLogsPage.vue'),
      },
    ],
  },
]
